...
/* Tests_SRS_UMOCKCALLPAIRS_01_002: [ umockcallpairs_track_create_paired_call shall copy the handle to the handle_value member of the new entry. ] */
...
/* Tests_SRS_UMOCKCALLPAIRS_01_004: [ If any of the arguments paired_handles, handle or handle_type is NULL, umockcallpairs_track_create_paired_call shall fail and return a non-zero value. ]*/
...
/* Tests_SRS_UMOCKCALLPAIRS_01_012: [ If the paired handles array is empty after removing the entry, the paired_handles field shall be freed and set to NULL. ]*/
