...
{
    // arrange
    wchar_t* input1_data = malloc(7 * sizeof(wchar_t));
    ASSERT_IS_NOT_NULL(input1_data);
    wchar_t* input2_data = malloc(7 * sizeof(wchar_t));
...
{
    // arrange
    wchar_t* input1_data = malloc(5 * sizeof(wchar_t));
    ASSERT_IS_NOT_NULL(input1_data);
    wchar_t* input2_data = malloc(5 * sizeof(wchar_t));
    ASSERT_IS_NOT_NULL(input2_data);
    int result;
