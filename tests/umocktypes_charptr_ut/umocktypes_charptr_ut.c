...
{
    // arrange
    char* input1 = malloc(7);
    ASSERT_IS_NOT_NULL(input1);
    char* input2 = malloc(7);
...
{
    // arrange
    char* input1 = malloc(5);
    ASSERT_IS_NOT_NULL(input1);
    char* input2 = malloc(5);
    ASSERT_IS_NOT_NULL(input2);
    int result;
...
TEST_FUNCTION(umocktypes_charptr_register_types_registers_all_types)
{
    ...
    ASSERT_ARE_EQUAL(char_ptr, "char const*", umocktypes_register_type_calls[2].type);
