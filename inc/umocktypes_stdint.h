...
#define UMOCKTYPES_STDINT_HANDLERS(type, function_postfix) \
    extern char* C2(umocktypes_stringify_,function_postfix)(volatile type* value); \
    extern int C2(umocktypes_are_equal_, function_postfix)(volatile type* left, volatile type* right); \
    extern int C2(umocktypes_copy_, function_postfix)(volatile type* destination, volatile type* source); \
    extern void C2(umocktypes_free_, function_postfix)(volatile type* value);
